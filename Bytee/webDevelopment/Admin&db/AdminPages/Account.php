...
<head>
    ...
    <script type="text/javascript" src="js/datatables_advanced.js"></script>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown dropdown-user">
						...
						<ul class="dropdown-menu dropdown-menu-right">
						  <li><a href="Account.html"><i class="icon-cog5"></i> تغيير كلمة المرور</a></li>
                        ...
                        <div class="category-content no-padding">
                            <ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="Category.html">إضافة أصناف<i class="icon-folder-plus"></i></a></li>
                                        <li><a href="AddProducts.html">إضافة منتج جديد<i class="icon-stack-plus"></i> </a></li>
                                        <li><a href="Productlist.html"><i class="icon-list2"></i>عرض المنتجات  </a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#"><i class="icon-users"></i> <span>الزبائن </span></a>
                                    <ul>
                                        <li><a href="userList.html"> <i class="icon-list"></i>  عرض مشتريات الزبائن</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#"><i class="icon-link"></i> <span>العروض الترويجية </span></a>
                                    <ul>
                                        <li><a href="AddPromotions.html">إضافة عرض خصم <i class="icon-plus-circle2"></i> </a></li>
                                        <li><a href="Promotionlist.html">إدارة الخصومات <i class="icon-checkbox-checked2"></i> </a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#"><i class="icon-file-empty2"></i> <span>المقالات </span></a>
                                    <ul>
                                        <li><a href="AddBlog.html"><i class="icon-file-plus2"></i>إضافة مقال جديد </a></li>
                                        <li><a href="Bloglist.html"><i class="icon-library2"></i>عرض المقالات </a></li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="ContactList.html"> <i class="icon-insert-template"></i>عرض الرسائل</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class=" panel-body">
                     ...
                     <div class="row">
                         <div class="col-sm-3 col-sm-offset-4">
                             <input type="submit" value="تغيير كلمة المرور" class="btn btn-success">
