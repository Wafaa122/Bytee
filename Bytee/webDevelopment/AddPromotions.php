                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 ">
                                    <div class="form-group">
                                        ...
                                        <input name ="Description" type="text" class="form-control summernote" />
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                   <div class="form-group">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <select  name ="product"selected="إختر المنتج">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input  name="promsubmit"type="submit" value="إضافة" class="btn btn-success">
